...
# filter to RABO/RASI comparison only (not RANA plate)

dat <- metadat %>% filter(RAD_ID=="RAD-220" | RAD_ID=="RAD-221" | RAD_ID=="RAD-222")
...
paste0("sbatch -p high -t 24:00:00 --mail-type ALL --mail-user rapeek@ucdavis.edu 03a_pca_new.sh bamlist_mrg_",site,"_",bamNo,"k_thresh", " ", lsite, "_",bamNo,"k_thresh", " bamlists/POPS")
