...
#site<-"RABO_mfa" # RABO_mfa_hydro # RABO_nfmfa #RABO_sfa
site<-"RABO_mfa_subsamp"
# METADATA
...
# subsample only mfa (all) (rm sfa samples:)
dat <- filter(metadat, SPP_ID=="RABO", grepl('^MFA|^RUB|^NFMFA', Locality)) 

# hydropeaking only
dat <- filter(metadat, SPP_ID=="RABO", grepl('^MFA', Locality), !grepl('^MFA-US-R', Locality)) 

# nfmfa or sfa only
dat <- filter(metadat, SPP_ID=="RABO", grepl('^SFA', Locality)) 
...
nfmfa_ox <- bind_rows(nfmfa_sc, mfa_us_r)
#mfa_usox <- mfa_us_r
rm(mfa_us_r)
rub_lcus <- rub_lc_us
rm(rub_lc_us)
...
# FOR SUBPOPS
sites<-ls(pattern = "mfa|nfmfa|rub|sfa") # need to make a list of site names
...
## create thetalists:
## in bamlists/subpops:
# ls bamlist_mrg_mfa* | grep "k$" | sed 's/bamlist_mrg_//g' > thetalist_mfa
# ls bamlist_mrg_rub* | grep "k$" | sed 's/bamlist_mrg_//g' >> thetalist_mfa
# ls bamlist_mrg_sfa* | grep "k$" | sed 's/bamlist_mrg_//g' >> thetalist_mfa
# ls bamlist_mrg_nfmfa* | grep "k$" | sed 's/bamlist_mrg_//g' >> thetalist_mfa
## mv list out:
# mv thetalist_mfa ../../

# sbatch -p high -t 12:00:00 06_theta_sfs.sh thetalist_mfa

# 8. BASH: Calc Pairwise FST ---------------------------------------------

sites<-ls(pattern = "mfa|sfa|rub") 
...
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k mfa_gasc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k mfa_todc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k nfmfa_ox_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k nfmfa_sc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k mfa_todc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k nfmfa_ox_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k nfmfa_sc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_todc_100k nfmfa_ox_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_todc_100k nfmfa_sc_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k rub_lcus_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_amec_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k rub_lcus_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_gasc_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_todc_100k rub_lcus_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_todc_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh mfa_todc_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_ox_100k rub_lcus_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_ox_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_ox_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_sc_100k rub_lcus_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_sc_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh nfmfa_sc_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh rub_lcus_100k rub_usph_100k
sbatch -p high -t 12:00:00 07_get_fst.sh rub_lcus_100k sfa_cami_100k
sbatch -p high -t 12:00:00 07_get_fst.sh rub_usph_100k sfa_cami_100k
