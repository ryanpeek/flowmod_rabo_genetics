...
# POP: this is for main bamlist (remove unknown location EBNF samples)
dat <- filter(metadat, SPP_ID=="RABO", grepl('^FEA|^NFF', Locality), !is.na(HU_10_NAME)) 

# NFF only
dat <- filter(metadat, SPP_ID=="RABO", grepl('^NFF', Locality), !is.na(HU_10_NAME)) 
...
names(dat2)<-gsub(pattern = "fea_", x = tolower(names(dat2)), replacement = "fea_Rb_")
names(dat2)
...
# split out the Poe reach into two groups (no samples at 100k)
...
# FOR SUBPOPS
sites<-ls(pattern = "fea") # need to make a list of site names
...
# ls bamlist_mrg_fea* | grep "k$" | sed 's/bamlist_mrg_//g' > thetalist_fea

## mv list out:
# mv thetalist_fea ../../

# sbatch -p high -t 12:00:00 06_theta_sfs.sh thetalist_fea

# 8. BASH: Calc Pairwise FST ---------------------------------------------

sites<-ls(pattern = "fea") 
...
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_beanck_100k fea_Rb_nff_poe_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_beanck_100k fea_Rb_spanish_bgulch_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_beanck_100k fea_Rb_spanish_silverck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_beanck_100k fea_Rb_spanishck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_nff_poe_100k fea_Rb_spanish_bgulch_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_nff_poe_100k fea_Rb_spanish_silverck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_nff_poe_100k fea_Rb_spanishck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_spanish_bgulch_100k fea_Rb_spanish_silverck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_spanish_bgulch_100k fea_Rb_spanishck_100k
sbatch -p high -t 12:00:00 07_get_fst.sh fea_Rb_spanish_silverck_100k fea_Rb_spanishck_100k
